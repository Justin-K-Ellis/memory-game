const ScoreBoard = (props) => {
  return (
    <div className="rounded border-2 border-white border-solid p-2 w-11/12 mx-auto my-2 flex flex-col text-white justify-center items-center bg-lime-600 shadow-md">
